...
def reg():
    ...
    def cam():
        ...
        while True:
            ...
            cv2.imwrite(r"C:/Users/iamsh/OneDrive/Desktop/Face/user_image/pic"+str(x)+".jpg",frame)
        ...
        path="C:/Users/iamsh/OneDrive/Desktop/Face/user_image/pic"+str(x)+".jpg"
        img=Image.open(r"C:\Users\iamsh\OneDrive\Desktop\Face\user_image\pic"+str(x)+".jpg")
    ...
    #---ICON_IMAGE---
    icon=Label(root)
    img=Image.open(r"C:\Users\iamsh\OneDrive\Desktop\Face\images\x1.png")
    img=ImageTk.PhotoImage(img)
    ...
    img=Image.open(r"C:\Users\iamsh\OneDrive\Desktop\Face\images\reg.jpg")
    img=ImageTk.PhotoImage(img)
