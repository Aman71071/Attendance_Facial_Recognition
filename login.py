...
def log():
    ...
    def auth():
        ...
        def att():
            ...
            def click():
                ...
                while True:
                    ...
                    cv2.imwrite(r"C:/Users/iamsh/OneDrive/Desktop/Face/user_image/att.jpg",frame)
                    cam=(r"C:/Users/iamsh/OneDrive/Desktop/Face/user_image/att.jpg")
                    imgc=Image.open(cam)
            ...
            def match():
                ...
                img2=face_recognition.load_image_file("C:/Users/iamsh/OneDrive/Desktop/Face/user_image/att.jpg")
            ...
            bg=Label(at)
            img=Image.open(r"C:\Users\iamsh\OneDrive\Desktop\Face\images\bg.jpg")
            ...
            c_img=Label(fc)
            imgc=Image.open(r"C:\Users\iamsh\OneDrive\Desktop\Face\images\cam.jpg")
            imgc=imgc.resize((480,330),Image.ANTIALIAS)
            imgc=ImageTk.PhotoImage(imgc)
            c_img.config(image=imgc)
            c_img.image=imgc
            ...
            #---UPLOAD_IMAGE_BUTTON---
            upl_btn=Button(fr2)
            img=Image.open(r"C:\Users\iamsh\OneDrive\Desktop\Face\images\upload.jpg")
            img=ImageTk.PhotoImage(img)
            ...
            #---MARK_ATTENDANCE---
            att_btn=Button(at)
            img=Image.open(r"C:\Users\iamsh\OneDrive\Desktop\Face\images\mark.jpg")
            img=ImageTk.PhotoImage(img)
        ...
        #---ICON_IMAGE---
        icon=Label(dash)
        img=Image.open(r"C:\Users\iamsh\OneDrive\Desktop\Face\images\x2.png")
        img=ImageTk.PhotoImage(img)
        ...
        #---HOME_BUTTON---
        h_btn=Button(frame1)
        img=Image.open(r"C:\Users\iamsh\OneDrive\Desktop\Face\images\home.jpg")
        img=ImageTk.PhotoImage(img)
        ...
        for data in res:
            ...
            img=Image.open(r"C:\Users\iamsh\OneDrive\Desktop\Face\images\tick.jpg")
            img=ImageTk.PhotoImage(img)
            ...
            img=Image.open(r"C:\Users\iamsh\OneDrive\Desktop\Face\images\logout.jpg")
            img=ImageTk.PhotoImage(img)
    ...
    img=Image.open(r"C:\Users\iamsh\OneDrive\Desktop\Face\images\log.jpg")
    img=ImageTk.PhotoImage(img)
